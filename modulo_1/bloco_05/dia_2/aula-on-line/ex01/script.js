...
const weekDaysListUL = document.querySelector('.week-days');

for (let index = 0; index < weekDays.length; index += 1) {
  let day = weekDays[index]; // Segunda

  let dayListItemLI = document.createElement('li');
  dayListItemLI.innerHTML = day;

  weekDaysListUL.appendChild(dayListItemLI);
};
