...
from pokemon import retrieve_pokemons_by_type, retrieve_pokemons_by_type_2
...
def test_retrieve_pokemons_by_type_2():
    # definimos um pokemon do tipo grama
    grass_type_pokemon = {
        "national_number": "001",
        "evolution": None,
    ...
    with patch("builtins.open", mock_open(read_data=pokemon_json_content)):
        ...
        assert retrieve_pokemons_by_type_2("Grass", "dummy") == [
            grass_type_pokemon
        ]
